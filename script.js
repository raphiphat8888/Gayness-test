const questions = [
    ...
    {
        question: "12. ภาพนี้... 2 คนนี้นอนด้วยกันแปลกไหม หรือเค้าอาจจะอาบน้ำด้วยกันเลยก็ได้มั้ง? 🚿",
        image: "img/Gemini_Generated_Image_hxduthxduthxduth.png",
        options: [
            { text: "โอ๊ยย! เกินเพื่อนไปร้อยมิติแล้ว อาบด้วยกันชัวร์!", score: 3, feedback: "เพื่อนผีอะไรจะขนาดนี้! หวานเจี๊ยบบบ อ่านเกมขาดสุดๆๆ ไปเลยแม๊!" },
            { text: "น่าจะสนิทกันมากแหละ... มั้งนะ", score: 2, feedback: "เรดาร์แอบเบลอนะเนี่ย แต่ก็ยังพอเดาทางออกอยู่บ้าง" },
            { text: "แค่พี่ชายน้องชาย หรือเปล่านะ?", score: 1, feedback: "พี่น้องกันแบบไหนคะพี่สาว... มองโลกแง่ดีเกิ๊นนน" },
            { text: "ไม่เห็นแปลกเลย ผู้ชายเค้าก็นอนแบบนี้แหละ!", score: 0, feedback: "ไม่แปลกก็แย่แล้ววว! โดนตกตาบอดแบบไม่รู้ตัวเลยนะ 555" }
        ]
    }
];

const results = [
    { min: 0, max: 9, title: "เกย์น้อย", desc: "คุณเป็นเกย์น้อย แสดงถึงความอ่อนโยนและความสนใจในความเป็นตัวเองแบบเบาๆ ยังไม่ถึงขั้นตัวแม่แต่มีความละมุนน่ารักซ่อนอยู่", icon: "fa-solid fa-heart", color: "#ff80ab" },
    { min: 10, max: 18, title: "เกย์ มาก", desc: "คุณเริ่มแสดงความเป็นเกย์อย่างชัดเจน มีความแซ่บและเปิดเผยตัวเองมากขึ้น", icon: "fa-solid fa-fire", color: "#ff2a85" },
    { min: 19, max: 27, title: "เกย์ตัวแม่", desc: "คุณเป็นเกย์ตัวแม่! แฟชั่นเป๊ะ ความแซ่บเต็มสูบ ใครเห็นก็ต้องยอมรับ", icon: "fa-solid fa-crown", color: "#f5c542" },
    { min: 28, max: 36, title: "เกย์สุดยอด", desc: "คุณเป็นเกย์สุดยอด! จุดศูนย์กลางของความแซ่บและความมั่นใจระดับสูงสุด", icon: "fa-solid fa-star", color: "#8a2be2" }
];
